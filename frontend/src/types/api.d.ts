...
export interface paths {
    ...
    "/account/projects": {
        ...
        get: operations["getAccountProjects"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/account/subscribed-shops": {
        ...
        get: operations["getAccountSubscribedShops"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/shops/{shopId}/clear-cache": {
        ...
        post: operations["clearShopCache"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/shops/{shopId}/tasks/{taskId}/reschedule": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/shops/{shopId}/subscribe": {
        ...
        post: operations["subscribeToShop"];
        /** Unsubscribe from shop notifications */
        delete: operations["unsubscribeFromShop"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/shops/{shopId}/sitespeed-settings": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/organizations/{orgId}/projects": {
        ...
        get: operations["getOrganizationProjects"];
        put?: never;
    ...
    "/organizations/{orgId}/projects/{projectId}/api-keys/{keyId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/organizations/{orgId}/projects/{projectId}/packages-tokens": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/organizations/{orgId}/projects/{projectId}/packages-tokens/{tokenId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/organizations/{orgId}/projects/{projectId}/packages-tokens/{tokenId}/sync": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/shops/{shopId}/deployments/{deploymentId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        AccountExtension: {
            ...
            shops: components["schemas"]["AccountExtensionShop"][];
        };
        AccountExtensionShop: {
            shopId: number;
            shopName: string;
            shopOrganizationName: string;
            shopOrganizationId: string;
            shopUrl: string;
            active: boolean;
            version: string;
            latestVersion: string;
        ...
        AdminShopsResponse: {
            shops: components["schemas"]["AccountShop"][];
            total: number;
        };
        AdminStats: {
            totalUsers: number;
        ...
        AdminGrowth: {
            ...
            shops: components["schemas"]["GrowthDataPoint"][];
        };
        GrowthDataPoint: {
            month: string;
            count: number;
        ...
        AdminRecentActivity: {
            ...
            recentShops: components["schemas"]["AccountShop"][];
        };
...
export interface operations {
    ...
    getAccountProjects: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AccountProject"][];
                };
            };
            401: components["responses"]["Unauthorized"];
        };
    ...
    getAccountSubscribedShops: {
        ...
        requestBody?: never;
        responses: {
            /** @description List of subscribed shops */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["SubscribedShop"][];
                };
            };
            401: components["responses"]["Unauthorized"];
        };
    ...
    refreshShop: {
        ...
        responses: {
            /** @description Shop refresh triggered */
            204: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    adminGetShops: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminShopsResponse"];
                };
            };
            401: components["responses"]["Unauthorized"];
            403: components["responses"]["Forbidden"];
