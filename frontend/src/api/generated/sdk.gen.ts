 ...
 */
export const updateUptimeSettings = <ThrowOnError extends boolean = false>(options: Options<UpdateUptimeSettingsData, ThrowOnError>): RequestResult<UpdateUptimeSettingsResponses, UpdateUptimeSettingsErrors, ThrowOnError> => (options.client ?? client).put<UpdateUptimeSettingsResponses, UpdateUptimeSettingsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getEnvironmentUptime = <ThrowOnError extends boolean = false>(options: Options<GetEnvironmentUptimeData, ThrowOnError>): RequestResult<GetEnvironmentUptimeResponses, GetEnvironmentUptimeErrors, ThrowOnError> => (options.client ?? client).get<GetEnvironmentUptimeResponses, GetEnvironmentUptimeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
