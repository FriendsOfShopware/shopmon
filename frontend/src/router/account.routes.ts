...
export default {
    ...
    children: [
        ...
        { name: 'account.shops.edit', path: 'teams/edit/:teamId/:shopId', component: () => import('@/views/account/EditShop.vue') },
        { name: 'account.shops.detail', path: 'teams/:teamId/:shopId', component: () => import('@/views/account/DetailShop.vue') },
    ]
};
