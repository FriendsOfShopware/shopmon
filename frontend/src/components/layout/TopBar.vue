      ...
      <div class="top-bar-actions">
        ...
        <popover class="notifications">
          <popover-button class="action notifications" @click="markAllRead">
            ...
            <div v-if="unreadNotificationCount > 0" class="notifications-count">
              ...
              <ul v-if="notifications.length > 0" class="notifications-list">
                ...
                >
                  <div class="notification-icon">
                    ...
                    <icon-fa6-solid:circle-info v-else class="icon icon-warning" />
                  </div>
                  ...
                  <div class="notification-delete">
                    <button type="button" @click="deleteNotification(notification.id)">
