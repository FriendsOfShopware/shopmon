    ...
    >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
            ...
            <div class="flex ml-4 md:ml-6 items-center gap-3">
                <button
                    class="text-sky-200 h-8 w-8 bg-sky-400 p-1 rounded-full hover:text-white focus:outline-none
                ...
                >
                    <popover-button
                        class="h-8 w-8 bg-sky-400 p-1 rounded-full text-sky-200 hover:text-white focus:outline-none flex
                    ...
                    >
                        ...
                        <div
                            ...
                            class="absolute -right-2 -top-1 ml-2 bg-red-500 rounded-full px-0.5 py-0.5 min-w-[20px]
                    ...
                    >
                        <popover-panel
                            class="absolute left-0 right-0 z-20 mt-2 w-screen px-4
                        sm:px-0 md:max-w-[400px] md:left-auto"
                        >
                ...
                <div class="hidden md:block">
                    ...
                    >
                        <div>
                            <menu-button
                                class="max-w-xs bg-sky-400 rounded-full flex items-center text-sm
                ...
                <disclosure-button
                    ...
                    :class="[
                        item.route == $route.path ?
                            ...
                            'text-white hover:text-white hover:bg-sky-400 hover:bg-opacity-75 dark:text-white' +
            ...
            <div class="pt-4 pb-3 border-t border-sky-400">
                ...
                <div class="mt-3 px-2 space-y-1">
                    <disclosure-button
                        ...
                        :key="item.name"
                        as="a"
                        class="block px-3 py-1 rounded-md text-base font-medium text-white hover:text-white hover:bg-sky-400
                        hover:bg-opacity-75 dark:text-white dark:hover:text-white"
                        @click="
                            item.route === '/logout'
                                ? authStore.logout()
