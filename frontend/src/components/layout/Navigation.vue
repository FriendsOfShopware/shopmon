    ...
    >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
            ...
            <div class="flex ml-4 md:ml-6 items-center gap-3">
                <button
                    class="text-sky-200 h-8 w-8 bg-sky-400 p-1 rounded-full hover:text-white
                ...
                >
                    <popover-button
                        class="h-8 w-8 bg-sky-400 p-1 rounded-full text-sky-200 hover:text-white
                        focus:outline-none flex justify-center items-center"
                    ...
                    >
                        ...
                        <div
                            ...
                            class="absolute -right-2 -top-1 ml-2 bg-red-500 rounded-full
                            px-0.5 py-0.5 min-w-[20px] text-xs font-medium text-white"
                        >
                    ...
                    >
                        ...
                        >
                            <div class="overflow-hidden rounded-md shadow-lg bg-white dark:bg-neutral-800">
                                <div
                                    class="p-4 font-medium border-b border-grey-200 flex
                                justify-between dark:border-neutral-700"
                                >
                                    Notifications
                                    <button
                ...
                <div class="hidden md:block">
                    ...
                    >
                        <div>
                            <menu-button
                                class="max-w-xs bg-sky-400 rounded-full flex items-center
                        ...
                        >
                            <menu-items
                                ...
                                py-1 bg-white focus:outline-none z-10 dark:bg-neutral-800"
                            >
