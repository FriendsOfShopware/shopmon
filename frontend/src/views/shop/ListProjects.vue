            ...
            >
              <menu-items class="menu-panel">
                ...
                <menu-item>
                  <router-link
                    class="menu-item"
                    :to="{ name: 'account.projects.apikeys', params: { projectId: project.id } }"
                  >
                ...
                <menu-item>
                  <button
                    class="menu-item"
                    :disabled="(projectShops[project.id]?.length || 0) > 0"
    ...
    <template #content>
      ...
      >
        ...
        <div class="mt-1">
          ...
          <field id="description" v-slot="{ field }" name="description" type="textarea">
            <textarea
              v-bind="field"
              id="description"
              autocomplete="off"
