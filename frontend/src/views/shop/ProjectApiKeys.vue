    ...
    <main-container>
        <div class="panel">
            <Alert type="info">
                ...
                <p>API keys allow external applications to interact with your project. Each key can have specific scopes to limit what actions it can perform.</p>
            </Alert>
            ...
            <div v-else-if="apiKeys.length === 0" class="api-keys-empty">
                ...
                <p class="text-muted">Create an API key to allow external applications to access your project.</p>
            </div>
            ...
            <div v-else class="api-keys-list">
                <div v-for="apiKey in apiKeys" :key="apiKey.id" class="api-key-item">
                    <div class="api-key-info">
                        ...
                        <p v-if="apiKey.lastUsedAt" class="text-muted">Last used {{ formatDate(apiKey.lastUsedAt) }}</p>
        ...
        >
            ...
            <template #content>
                <Alert type="warning">
                    ...
                    <p>This is the only time you will see this key. Make sure to copy it and store it securely.</p>
                </Alert>
