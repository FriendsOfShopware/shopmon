<template>
    <div class="deployments-container">
            ...
            >
                ...
                <template #cell-actions="{ row }">
                    <div class="action-buttons">
                        ...
                        <button
                            class="btn btn-danger btn-sm"
                            @click="confirmDeleteDeployment(row)"
                        >
                            <icon-fa6-solid:trash class="icon" />
                        </button>
                    </div>
        ...
        <modal
            :show="showDeleteTokenDialog"
            close-x-mark
            @close="showDeleteTokenDialog = false"
        >
            <template #icon>
            ...
            <template #footer>
                ...
                <button
                    type="button"
                    class="btn"
                    @click="showDeleteTokenDialog = false"
                >
                    Cancel
                </button>
            </template>
        ...
        >
            ...
            <template #footer>
                ...
                <button
                    type="button"
                    class="btn"
                    @click="showDeleteDeploymentDialog = false"
                >
                    Cancel
                </button>
            </template>
