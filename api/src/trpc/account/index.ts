...
export const accountRouter = router({
    ...
    currentUser: publicProcedure
        ...
        .query(async ({ ctx }) => {
            return await AccountService.getCurrentUser(
                ctx.drizzle,
                ctx.user.id,
            );
        }),
    currentUserExtensions: publicProcedure
        .use(loggedInUserMiddleware)
        .query(async ({ ctx }) => {
            return await AccountService.getCurrentUserExtensions(
                ctx.drizzle,
                ctx.user.id,
            );
        }),
    listOrganizations: publicProcedure
        .use(loggedInUserMiddleware)
        .query(async ({ ctx }) => {
            return await AccountService.listOrganizations(
                ctx.drizzle,
                ctx.user.id,
            );
        }),
    currentUserShops: publicProcedure
        .use(loggedInUserMiddleware)
        .query(async ({ ctx }) => {
            return await AccountService.getCurrentUserShops(
                ctx.drizzle,
                ctx.user.id,
            );
        }),
    currentUserProjects: publicProcedure
        .use(loggedInUserMiddleware)
        .query(async ({ ctx }) => {
            return await AccountService.getCurrentUserProjects(
                ctx.drizzle,
                ctx.user.id,
            );
        }),
    currentUserChangelogs: publicProcedure
        .use(loggedInUserMiddleware)
        .query(async ({ ctx }) => {
            return await AccountService.getCurrentUserChangelogs(
                ctx.drizzle,
                ctx.user.id,
            );
        }),
