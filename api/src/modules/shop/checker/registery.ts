...
export class CheckerOutput {
  ...
  success(id: string, message: string, source = "Shopmon", link: string | null = null) {
    this.checks.push({
      id,
      level: "green",
      message: message,
  ...
  warning(id: string, message: string, source = "Shopmon", link: string | null = null) {
    this.checks.push({
      id,
      level: "yellow",
      message: message,
  ...
  error(id: string, message: string, source = "Shopmon", link: string | null = null) {
    this.checks.push({
      id,
      level: "red",
      message: message,
