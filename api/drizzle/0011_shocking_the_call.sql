...
--> statement-breakpoint
INSERT INTO "member" ("id", "organization_id", "user_id", "role", "created_at") SELECT substr(concat('00000000000000000000000000000000'||"rowid"), -32, 32), "organization_id", "user_id", CASE WHEN((SELECT owner_id FROM organization WHERE id = organization_id) == user_id) THEN "admin" ELSE "member" END, date("now") FROM `user_to_organization`;
--> statement-breakpoint
